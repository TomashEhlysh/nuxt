...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-ChzyqJzn.js")
  },
  {
    name: "goods",
    path: "/goods",
    component: () => import("./_nuxt/goods-5Biq8qmf.js")
  },
  {
    name: "Goods-id",
    path: "/Goods/:id()",
    component: () => import("./_nuxt/_id_-D0e-azPY.js")
  },
  {
    name: "Goods-addGoods",
    path: "/Goods/addGoods",
    component: () => import("./_nuxt/addGoods-CC8qC0qb.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-C62n3Ens.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B7MBVB9_.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CrDn7ayR.js"));
