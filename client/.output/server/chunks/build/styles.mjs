...
const styles = {
  "pages/goods.vue": () => import('./goods-styles.CBqaxC-_.mjs').then(interopDefault),
  "pages/goods.vue?vue&type=style&index=0&scoped=cf136b12&lang.css": () => import('./goods-styles.DcIgsKPc.mjs').then(interopDefault),
