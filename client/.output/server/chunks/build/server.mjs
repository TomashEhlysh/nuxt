...
import { $ as $fetch, l as defu, p as parseQuery, m as createHooks, e as createError$1, n as hasProtocol, o as joinURL, q as getContext, r as isScriptProtocol, w as withQuery, v as sanitizeStatusCode, x as withTrailingSlash, y as withoutTrailingSlash, z as toRouteMatcher, A as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-ChzyqJzn.mjs')
  },
  {
    name: "goods",
    path: "/goods",
    component: () => import('./goods-5Biq8qmf.mjs')
  },
  {
    name: "Goods-id",
    path: "/Goods/:id()",
    component: () => import('./_id_-D0e-azPY.mjs')
  },
  {
    name: "Goods-addGoods",
    path: "/Goods/addGoods",
    component: () => import('./addGoods-CC8qC0qb.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C62n3Ens.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/goods" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Goods`);
      } else {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-B7MBVB9_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CrDn7ayR.mjs'));
